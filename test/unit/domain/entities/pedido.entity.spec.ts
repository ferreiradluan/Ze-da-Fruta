...
import { STATUS_PEDIDO, StatusPedido } from '../../../../src/2-sales/domain/types/status-pedido.types';
...
describe('Pedido Entity', () => {
  ...
  describe('criarNovo', () => {
    it('deve criar um novo pedido válido', () => {
      ...
      expect(pedido.status).toBe(STATUS_PEDIDO.PAGAMENTO_PENDENTE);
  ...
  describe('confirmar', () => {
    it('deve confirmar pedido com endereço válido', () => {
      ...
      // Assert
      expect(pedido.status).toBe(STATUS_PEDIDO.PAGO);
    });
  ...
  describe('cancelar', () => {
    it('deve cancelar pedido com motivo', () => {
      ...
      // Assert
      expect(pedido.status).toBe(STATUS_PEDIDO.CANCELADO);
    });
