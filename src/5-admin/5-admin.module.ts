...
import { ProdutosAdminController } from './api/controllers/produtos-admin.controller';
import { UsuariosAdminController } from './api/controllers/usuarios-admin.controller';
import { EstabelecimentosAdminController } from './api/controllers/estabelecimentos-admin.controller';
...
@Module({
  ...
  controllers: [AdminController, ProdutosAdminController, UsuariosAdminController, EstabelecimentosAdminController],
  providers: [
    AdminService,
    AuditLogRepository,
